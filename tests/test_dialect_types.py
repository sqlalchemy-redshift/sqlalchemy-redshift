...
def test_defined_types():
    ...
    assert sqlalchemy_redshift.dialect.GEOMETRY is not sqlalchemy.sql.sqltypes.TEXT

    assert sqlalchemy_redshift.dialect.SUPER is not sqlalchemy.sql.sqltypes.TEXT
    ...
    assert sqlalchemy_redshift.dialect.HLLSKETCH is not sqlalchemy.sql.sqltypes.TEXT


custom_type_inheritance = [
    (sqlalchemy_redshift.dialect.GEOMETRY, sqlalchemy.sql.sqltypes.TEXT),
    (sqlalchemy_redshift.dialect.SUPER, sqlalchemy.sql.sqltypes.TEXT),
    ...
    (sqlalchemy_redshift.dialect.HLLSKETCH, sqlalchemy.sql.sqltypes.TEXT),
]
...
def test_custom_types_ddl_generation(custom_datatype, expected, stub_redshift_dialect):
