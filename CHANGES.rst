...
- Add support for Redshift ``DELETE`` statements that refer other tables in the ``WHERE`` clause
  clause. (`Issue #26 <https://github.com/graingert/redshift_sqlalchemy/pull/26>`_)
